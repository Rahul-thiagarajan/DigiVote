...
var ReactOriginal = __toModule(require_react());
...
function getContext() {
  ...
  if (!React.createContext)
    return {};
  const contextMap = (_a = gT[ContextKey]) != null ? _a : gT[ContextKey] = new Map();
    ...
    function ConnectFunction(props) {
      ...
      const ContextToUse = React.useMemo(() => {
        ...
        if (propsContext == null ? void 0 : propsContext.Consumer) {
          if (true) {
            const isValid = isContextConsumer(React.createElement(propsContext.Consumer, null));
            if (!isValid) {
      ...
      try {
        actualChildProps = useSyncExternalStore2(subscribeForReact, actualChildPropsSelector, getServerState ? () => childPropsSelector(getServerState(), wrapperProps) : actualChildPropsSelector);
      } catch (err) {
